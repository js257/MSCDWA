...
from networks.subnet.model import MSCDWA
...
class BertEncoder(nn.Module):
    ...
    def forward(self, hidden_states, visual=None, acoustic=None, visual_ids=None, acoustic_ids=None,
        ...
        # print("visual_ids:", visual_ids.shape)
...
class BertPooler(nn.Module):
    def __init__(self, config):
        ...
        self.den = nn.Linear(512, VISUAL_DIM)
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, visual=None, acoustic=None, visual_ids=None, acoustic_ids=None, pos_ids=None,
        ...
        encoder_outputs = self.encoder(embedding_output, visual, acoustic, visual_ids, acoustic_ids,  # 设计模型
