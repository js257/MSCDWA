...
def parser_args():
    ...
    parser.add_argument("--data_path", type=str, default='/media/dataset/MOSI_16_sentilare_unaligned_data.pkl')
    ...
    parser.add_argument("--model_name_or_path", default='/media/pretrained-model/sentilare_model', type=str,
